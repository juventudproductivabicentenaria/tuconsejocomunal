...
Cada Consejo comunal podrá realizar registros de noticias, tareas y encuentas y será notificados todos los miembros del consejo comunal
    ...
    'depends' : ['base_setup','survey','project','l10n_ve_dpt','inputmask_widget','backend_theme_v10','web_responsive'],
    'data': [
        ...
        'report/product_distribution.xml',          # Reporte Distribución
        'report/product_distribution_template.xml', # Reporte Plantilla Distribución
