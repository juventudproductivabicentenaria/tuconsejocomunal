...
class res_municipios(osv.osv):
    """Nombre de los Municipios"""
    _name = 'res.municipios'
    _rec_name = 'municipio'
    #_rec_name = 'codigo'
    #_rec_name = 'estado_id'
    ...
    _columns = {
        ...
        'estado_id': fields.many2one('res.estados', 'Estado', help='Estado que  esta  asociado  al  Municipio'),
        'active': fields.boolean('Activo'),
    }
    _defaults = {
        'active':True, 
...
class res_parroquias(osv.osv):
    """Nombre  de la Parroquia"""
    _name = 'res.parroquias'
    _rec_name = 'parroquia'
    #_rec_name = 'codigo'
    ...
    _columns = {
        ...
        'municipio_id': fields.many2one('res.municipios', 'Municipio', help='Municipio que  esta  relacionada a  la  Parroquia'),
        'active': fields.boolean('Activo'),
    }
    _defaults = {
        'active':True, 
